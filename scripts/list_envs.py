...
All the environments are registered in the `GO2_policy` extension. They start
...
import GO2_policy.tasks  # noqa: F401


def main():
    """Print all environments registered in `GO2_policy` extension."""
