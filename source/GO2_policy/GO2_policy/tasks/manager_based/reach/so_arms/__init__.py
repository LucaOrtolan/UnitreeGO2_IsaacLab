...
gym.register(
    id="Template-Isaac-SO-ARM100-Reach-v0",
...
gym.register(
    id="Template-Isaac-SO-ARM100-Reach-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Template-Isaac-SO-ARM101-Reach-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Template-Isaac-SO-ARM101-Reach-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
