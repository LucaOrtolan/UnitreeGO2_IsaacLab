...
##
from . import mdp
from GO2_policy.robots.unitree import UNITREE_GO2_WITH_D1_550_MANIPULATION_ONLY_CFG  # noqa: F401
...
@configclass
class D1550QuadrupedReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

        # switch robot to OpenArm
        self.scene.robot = UNITREE_GO2_WITH_D1_550_MANIPULATION_ONLY_CFG.replace(
...
@configclass
class D1550QuadrupedReachEnvCfg_PLAY(D1550QuadrupedReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
